    ...
    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
        <div class="box box-solid box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php echo __('Conjunction'); ?></h3>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                        ...
                        <p><span class="parts_of_speechName"><b>Conjunction</b></span> / <span class="claasification_of_speech"><b>conjunction</b></span></p>                      
						<?php 
							$conjunction_list = array(
			                     'and','so','or','or','Or','Otherwise','or','Or','But',
								 'moreover','So',
							); 
                                                        
                                                        $conjunction_list_bangla = array(
                                                            'ও','তাই','কিংবা','বা','অথবা','নতুবা','নাহয়','নয়তো',
                                                            'কিন্তু','অধিকন্তু','সুতরাং'
                                                        );
						?>
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            	...
                            	<?php for($i=0; $i<count($conjunction_list); $i++): ?>
                            		<?php
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $conjunction_list_bangla[$i]; ?></td>
                                    <?php echo $this->Form->input($i.'.Morphology.personnel_information_id',array('type'=>'hidden','value'=>$id,'class'=>'form-control','label'=>false,'style'=>'margin-top:3px')); ?>
                                     <?php echo $this->Form->input($i.'.Morphology.morphology_type',array('type'=>'hidden','value'=>'morphology_conjunction','class'=>'form-control','label'=>false,'style'=>'margin-top:3px')); ?>
                                    <td><?php echo $this->Form->input($i.'.Morphology.english_word',array('type'=>'hidden','value'=>$conjunction_list[$i],'class'=>'form-control','label'=>false,'style'=>'margin-top:3px')); ?><?php echo $conjunction_list[$i]; ?></td>

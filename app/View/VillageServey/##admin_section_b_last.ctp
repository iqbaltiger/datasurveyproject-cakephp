                        ...
                        <table class="table table-bordered table-striped">
                                   ...
                                   <td width="16%">
                                     	<?php 
                                          if (!empty($this->request->data['VillageSectionBSecondPart'][0]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.0.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));           	
                            ...
                            for($i=0;$i<=5;$i++):
	                               if (!empty($this->request->data['VillageSUrveyQuestion242Marker'][$i]['VillageQuestion242']['id'])) {
									...
									echo $this->Form->input('VillageSUrveyQuestion242Marker.'.$i.'.VillageQuestion242.interview_id',array('type'=>'hidden','value'=>$interview_id));                            
                                   ...
                                   <td width="16%">
                                     	<?php 
                                          if (!empty($this->request->data['VillageSectionBSecondPart'][1]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.1.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));           	
                            ...
                            ?>
                            <?php echo $this->Form->input('VillageQuestion244Marker.'.$i.'.VillageQuestion244.interview_id',array('type'=>'hidden','value'=>$interview_id));  ?>
                            <tr>
                                   ...
                                   <td width="16%">
                                     	<?php 
                                          if (!empty($this->request->data['VillageSectionBSecondPart'][2]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.2.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));           	
                            ...
                            <?php echo $this->Form->input('VillageQuestion246Marker.'.$i.'.VillageQuestion246.interview_id',array('type'=>'hidden','value'=>$interview_id));  ?>
                            ...
                            <tbody>
                              ...
                              <?php for($j=0;$j<6;$j++): ?>
                                ...
                                if (!empty($this->request->data['VillageQuestion247Marker'][$j]['VillageQuestion247']['id'])) {
                                 ...
                                 <tr> 
                                     <?php echo $this->form->input('VillageQuestion247Marker.'.$j.'.VillageQuestion247.interview_id',array('type'=>'hidden','value'=>$interview_id)); ?>
                                ...
                                <td>
                                     	<?php 
                                          if (!empty($this->request->data['VillageSectionBSecondPart'][3]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.3.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));           	
                                    		echo $this ->Form ->input('VillageSectionBSecondPart.3.VillageSectionBSecondPart.answer', array('options' => $array_fourth, 'class' => 'form-control', 'empty' => '(choose one)', 'label' => false)); 
                                    	?>                                    
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][9]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.9.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));                                 	
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][10]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.10.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));                                 	
                                       		echo $this ->Form ->input('VillageSectionBSecondPart.10.VillageSectionBSecondPart.answer', array('options' => $options_arrays[3], 'class' => 'form-control', 'empty' => '(choose one)', 'label' => false));    
                                    ?>
                                    </td>
                            </tr>							
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][11]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.11.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));                                 	
                                       		echo $this ->Form ->input('VillageSectionBSecondPart.11.VillageSectionBSecondPart.answer', array('type' => 'text', 'class' => 'form-control', 'label' => false));    
                                    ?>
                                    </td>
                            </tr>	
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][12]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.12.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));                                 	
                                       		echo $this ->Form ->input('VillageSectionBSecondPart.12.VillageSectionBSecondPart.answer', array('options' => $options_arrays[3], 'class' => 'form-control', 'empty' => '(choose one)', 'label' => false));    
                                    ?>
                                    </td>
                            </tr>							
                             <tr>
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][13]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.13.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));                                 	
                                       		echo $this ->Form ->input('VillageSectionBSecondPart.13.VillageSectionBSecondPart.answer', array('type' => 'text', 'class' => 'form-control', 'label' => false));    
                                    ?>
                                    </td>
                            </tr>							
                             ...
                             <tr>
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][14]['VillageSectionBSecondPart']['id'])) {
                                            echo $this->Form->input('VillageSectionBSecondPart.14.VillageSectionBSecondPart.id', array('type' => 'hidden'));
                                        } 
                                    		echo $this->Form->input('VillageSectionBSecondPart.14.VillageSectionBSecondPart.question_no',array('type'=>'hidden','value'=>261));  
											echo $this->Form->input('VillageSectionBSecondPart.14.VillageSectionBSecondPart.question',array('type'=>'hidden','value'=>'What is the size of that community settlement Unit (village/ punji/ para/ basti/ moholla) center?')); 
											echo $this->Form->input('VillageSectionBSecondPart.14.VillageSectionBSecondPart.interview_id',array('type'=>'hidden','value'=>$interview_id));                                 	
                                       		echo $this ->Form ->input('VillageSectionBSecondPart.14.VillageSectionBSecondPart.answer', array('options' => $mobile_operator, 'class' => 'form-control', 'empty' => '(choose one)', 'label' => false));    
                                    ?>
                                    </td>
                            </tr>							         
                               ...
                               $drop_down_text = array(
                                ...
                                <?php for($i=0;$i<count($palces_list);$i++): ?>
                     			<?php
                            		...
                            		echo $this->Form->input('VillageQuestion262Marker.'.$i.'.VillageQuestion262.question_no',array('type'=>'hidden','value'=>$i+244));  
									echo $this->Form->input('VillageQuestion262Marker.'.$i.'.VillageQuestion262.question',array('type'=>'hidden','value'=>$palces_list[$i])); 
									echo $this->Form->input('VillageQuestion262Marker.'.$i.'.VillageQuestion262.interview_id',array('type'=>'hidden','value'=>$interview_id));                               	
                             	?> 

                                <tr>
                                    <td><?php echo $i+263; ?></td>

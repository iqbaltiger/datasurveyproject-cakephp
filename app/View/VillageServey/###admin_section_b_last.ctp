...
//        var nuLLChack = $('#VillageSectionBSecondPart3VillageSectionBSecondPartAnswer').val();
//        
//        if(nuLLChack === null ){
//             $('#VillageSectionBSecondPart3VillageSectionBSecondPartAnswerOther').hide();
//            
//        }
//        
//        else{
//            $('#VillageSectionBSecondPart3VillageSectionBSecondPartAnswerOther').show();
//            
//        }


  $('#VillageSectionBSecondPart3VillageSectionBSecondPartAnswer').each(function() {
                                     	...
                                     	<?php 
                                          ...
                                          if (!empty($this->request->data['VillageSectionBSecondPart'][3]['VillageSectionBSecondPart']['id'])) {
                                    		...
                                    		echo $this ->Form ->input('VillageSectionBSecondPart.3.VillageSectionBSecondPart.answer', array('options' => $array_fourth, 'class' => 'form-control', 'empty' => '(choose one)','multiple'=>true, 'label' => false)); 
                                                ...
                                                echo $this->Form->input('VillageSectionBSecondPart.3.VillageSectionBSecondPart.answer_other',array('type'=>'text','class'=>'form-control','label'=>false,'style'=>'margin-top:5px;'));         
                                ...
                                <td>
                                	<?php
										...
										if (!empty($this->request->data['VillageSectionBSecondPart'][14]['VillageSectionBSecondPart']['id'])) {
											...
											echo $this->Form->input('VillageSectionBSecondPart.14.VillageSectionBSecondPart.village_interview_id',array('type'=>'hidden','value'=>$village_interview_id));                                 	

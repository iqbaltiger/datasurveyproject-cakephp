	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __('Village Survey'); ?></h3>
					...
					<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                       ...
                       <?php echo $this->Form->create('CommSectionAReferenceInformation',array('class'=>'')) ?>
                                            ...
                                            <?php $task_list_a = array(
                                                ...
                                                'Interview with Village People','Interview with NGO Officials','Interview with LGI Representatives',
                                                 ...
                                                 <?php for($i=0;$i<count($task_list_a);$i++):?>
                                                 	...
                                                 	<?php
                              						...
                              						?>
                                                         ...
                                                         <?php if($i==0){echo $this->Form->input('Reference.'.$i.'.VillageSectionAReferenceInformation.interview_key',array('type'=>'hidden','value'=>'1'));} ?>
                                                 	...
                                                 	<?php
														...
														echo $this ->Form->input('Reference.'.$i.'.VillageSectionAReferenceInformation.village_interview_id', array('type' => 'hidden','value'=>$pid));
                                                        ...
                                                        echo '<td>'.$this -> Form -> input('Reference.'.$i.'.VillageSectionAReferenceInformation.by_whom', array('type' => 'select','options'=>$users,'empty'=>'Select One', 'class' => 'form-control', 'label' => false, 'style' => 'margin-top:3px')).'</td>';
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                        ...
                                                        echo $this ->Form->input('Respond.'.$j.'.VillageSectionARespondentInformation.village_interview_id', array('type' => 'hidden','value'=>$pid));
                                                        ?>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <?php 
                                                        	echo $this ->Form->input('DataFile.'.$j.'.VillageSectionADataFile.file_type',array('type' => 'hidden','value'=>$recording_system[$j]));
                                                        	 echo $this ->Form->input('DataFile.'.$j.'.VillageSectionADataFile.village_interview_id', array('type' => 'hidden','value'=>$pid));
                                                        ?>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                        ...
                                                        echo '<tr><td>'.$task_list_a[$i].'</td>';
														echo $this ->Form->input('Qc.'.$i.'.VillageSectionAQualityControl.village_interview_id', array('type' => 'hidden','value'=>$pid));

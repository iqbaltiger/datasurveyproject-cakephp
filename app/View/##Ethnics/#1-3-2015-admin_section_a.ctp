				...
				<div class="row">
					<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                       ...
                       <?php echo $this->Form->create('Ethnic',array('class'=>'')) ?>
                                            ...
                                            <h4>A-02: INFORMATION OF THE RESPONDENT</h4>
                       ...
                       <?php
                          ...
                          $schooling = array(
                              'Illiterate/ no schooling','Can Read and Write',
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                               <tr><td>111</td><td>What is your name? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                ...
                                <tr><td>114</td><td>What is your religion? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                <tr><td>115</td><td>How old were you at your last birthday? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                <tr><td>116</td><td>Where were you born? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                ...
                                <tr><td>120</td><td>What is your ethnic identity? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                ...
                                <tr><td>122</td><td>What is the name of your ethnic group in government records?</td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                <tr><td>123</td><td>Is there any other given names of your ethnic group by which other ethnic groups of your neighborhood address you? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>                                                                                              
                                  
                            </tbody>
                        </table>
                        
                         <h4>A-03: LOCATION OF THE INTERVIEW</h4>
                       <table class="table table-bordered table-striped">
                            <tbody>                         
                                  <tr>
                                    <td>131</td>

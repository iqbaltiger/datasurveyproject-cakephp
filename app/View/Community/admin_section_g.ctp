                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                        ...
                        <h5><b>G-1: RELIGION AND RITUALS</b></h5>
                         ...
                         <?php echo $this->Form->create('CommunityQuestion701');?>
                        <table class="table table-bordered table-striped">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <?php $religion_list = array('preclassical','christianity','buddhism','hinduism','islam'); ?>
                            ...
                            <tbody>
                                ...
                                if (!empty($this->request->data['701_marker'][$j]['CommunityQuestion701']['id'])) {
                                            echo $this->Form->input('701_marker'.$j.'CommunityQuestion701.id', array('type' => 'hidden'));
                                        }
              						?> 
                                
                                
                                 <tr> 
                                     <?php echo $this->form->input('701_marker.'.$j.'.CommunityQuestion701.interview_id',array('type'=>'hidden','value'=>$interview_id)); ?>
                                     <td><?php echo $this->form->input('701_marker.'.$j.'.CommunityQuestion701.followers_percentage',array('type'=>'hidden','value'=>$followers_list[$j])); ?><?php echo $followers_list[$j]; ?></td>
                                    <?php for($i=0;$i<5;$i++): ?>
                                     
                                   
                                    <td><?php
                                        echo $this->form->input('701_marker.'.$j.'.CommunityQuestion701.'.$religion_list[$i], array(
                                            'label' => false,
                                ...
                                $answer_field_name_list = array('ans_a','ans_b','ans_c','ans_d','ans_e','ans_f','ans_g','ans_h','ans_i');
                                ...
                                ?>
								 ...
								 <?php
                                  ...
                                  // pr($this->request->data); exit;
                                if (!empty($this->request->data['CommunityQuestion702']['id'])) {
                                            echo $this->Form->input('CommunityQuestion702.id', array('type' => 'hidden'));
                                        }
              						?> 
                                
                                <tr>
                                    <?php echo $this->form->input('Community702Marker.CommunityQuestion702.interview_id',array('type'=>'hidden','value'=>$interview_id)); ?>
                                    <td><?php echo $this->form->input('Community702Marker.CommunityQuestion702.question',array('type'=>'hidden','value'=>'702')); ?>702</td>
                                    <td>Nature of Preclassical Animistic belief and practices.</td>
                                    <td colspan="4" style="text-align: left;">
                                      <?php foreach($answer_list_1 as $key=>$value): ?>  
                                        <?php
                                        echo $this->form->input('Community702Marker.CommunityQuestion702.'.$answer_field_name_list[$key], array(
                                            'label' => false,
                                            'value'=>$value,
                                            'id'=>$key.'checkbox',
                                      ...
                                      <?php endforeach; ?>  
                                        ...
                                        <?php echo $this -> Form -> input('Community702Marker.CommunityQuestion702.answer', array('type' => 'text','id'=>'0answer_other','class' => 'form-control','placeholder'=>'Please type here','label' => false, 'style' => 'margin-top:3px'));?>
                                    </td>
                                </tr>
                                
                               <tr>
                                    <?php echo $this->form->input('Community703Marker.CommunityQuestion702.interview_id',array('type'=>'hidden','value'=>$interview_id)); ?>
                                    <td><?php echo $this->form->input('Community702Marker.CommunityQuestion702.question',array('type'=>'hidden','value'=>'703')); ?>703</td>
                                    <td>Nature and form of Hinduism and practices </td>
                                     <td colspan="4" style="text-align: left;">
                                      <?php foreach($answer_list_2 as $key=>$value): ?>  
                                        <?php
                                        echo $this->form->input('Community703Marker.CommunityQuestion702.'.$answer_field_name_list[$key], array(
                                            'label' => false,
                                            'value'=>$value,
                                            'id'=>$key.'checkbox',
                                            'after'=>'<label>'.$value.'</label>',
                                      ...
                                      <?php endforeach; ?>  
                                        ...
                                        <?php echo $this -> Form -> input('Community703Marker.CommunityQuestion702.answer', array('type' => 'text','id'=>'0answer_other','class' => 'form-control','placeholder'=>'Please type here','label' => false, 'style' => 'margin-top:3px'));?>
                                    </td>
                                </tr>

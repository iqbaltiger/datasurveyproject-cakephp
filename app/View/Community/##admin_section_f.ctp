                    ...
                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php  echo $this ->Form ->input($i.'.SectionQuestionAnswerF.answer_list', array('options' =>$ans_f1[$i], 'class' => 'form-control', 'empty' => '(choose one)', 'label' => false)); ?>
                                ...
                                <script>
                                  ...
                                  $('#'+<?php echo $i; ?>+'SectionQuestionAnswerFAnswerList').change(function () {
                            
                                            var selectboxValue = $('#'+<?php echo $i; ?>+'SectionQuestionAnswerFAnswerList').val();
                        ...
                        <?php 
                          ...
                          $succession_row_list = array(
                             '2'=>'What is the Succession to the Office of Local Village head? (Lowest Level Coesidential Unit)',
                              'What is the <b>Type of Hereditary Succession</b> to the Office of Local Village head? (Lowest Level Coesidential Unit)',
                        ...
                        ?>
                         <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i+608;?></td>  
                                    <td><?php echo $succession_row_list[$i]; ?></td>
                                    <td>
                                        <?php  
                                        
                                      //  foreach($succession_answer as $key=>$value):

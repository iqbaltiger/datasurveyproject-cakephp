				...
				<div class="row">
					<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                       ...
                       <?php echo $this->Form->create('CommSectionAReferenceInformation',array('class'=>'')) ?>
							...
							echo $this ->Form->input('Reference.'.$i.'.CommSectionAReferenceInformation.com_interview_id', array('type' => 'hidden','value'=>$pid));
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
			                                            if (!empty($this->data['Respond'][$j]['CommSectionARespondentInformation']['id'])) {
			                                                echo $this->Form->input('Respond.'.$j.'.CommSectionARespondentInformation.id', array('type' => 'hidden'));
			                                            }
                              						?>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <?php 
                                                        echo $this ->Form->input('Respond.'.$j.'.CommSectionARespondentInformation.category',array('type' => 'hidden','value'=>$recording_system[$j]));
                                                        echo $this ->Form->input('Respond.'.$j.'.CommSectionARespondentInformation.com_interview_id', array('type' => 'hidden','value'=>$pid));
                                                        ?>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php for($j=0;$j<count($recording_system);$j++): ?>
                                                     ...
                                                     <?php
			                                            if (!empty($this->data['DataFile'][$j]['CommSectionADataFile']['id'])) {
			                                                echo $this->Form->input('DataFile.'.$j . '.CommSectionADataFile.id', array('type' => 'hidden'));
			                                            }
                              						?> 	
                                                   ...
                                                   <tr>
                                                        ...
                                                        <?php 
                                                        	echo $this ->Form->input('DataFile.'.$j.'.CommSectionADataFile.file_type',array('type' => 'hidden','value'=>$recording_system[$j]));
                                                        	 echo $this ->Form->input('DataFile.'.$j.'.CommSectionADataFile.com_interview_id', array('type' => 'hidden','value'=>$pid));
                                                        ?>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
			                                            ...
			                                            if (!empty($this->data['Qc'][$i]['CommSectionAQualityControl']['id'])) {
			                                                echo $this->Form->input('Qc.'.$i . '.CommSectionAQualityControl.id', array('type' => 'hidden'));
			                                            }
                              					
                                                        echo '<tr><td>'.$task_list_a[$i].'</td>';
														echo $this ->Form->input('Qc.'.$i.'.CommSectionAQualityControl.com_interview_id', array('type' => 'hidden','value'=>$pid));
														echo $this ->Form->input('Qc.'.$i.'.CommSectionAQualityControl.task', array('type' => 'hidden','value'=>$task_list_a[$i]));
                                                        echo '<td>'.$this ->Form->input('Qc.'.$i.'.CommSectionAQualityControl.date', array('type' => 'text','id'=>'check_in_dates_'.$i, 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px')).'</td>';

...
<body class="skin-blue" data-baseurl="<?php echo $this->base;?>">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<?php 
                if($this->params['controller']=='cultural'){
                    echo $this->element('admin/cultural_household_sidebar'); 
                }elseif($this->params['controller']=='community'){
                    echo $this->element('admin/community_house_hold_sidebar'); 
                }elseif($this->params['controller']=='ethnics'){
                    echo $this->element('admin/ethnic_sidebar'); 
                }elseif($this->params['controller']=='VillageServey'){
                    echo $this->element('admin/village_servey_sidebar'); 
                }                     
                ?>

                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    ...
                                    <th colspan="3"> <?php echo $this->form->input('cultivate_anyland',array('type'=>'select','class'=>'form-control','options'=>array('0'=>'Yes','1'=>'No'),'label'=>false,'div'=>false)); ?></th>
<!--                                    <th><strong>Yes</strong></th>
                                ...
                                <?php $section_ga_list_upperPart = array('1. Agricultural land', '2. Domestic land (Homestead and yard)', '3. Horticultural land near the household', '4. Herding pasture', '5. Agricultural forest', '6. Fallow land', '7. Other Khas land (C.P.R- Common property)',
                                    '8. Land given for sharecropping (Including 1-6)', '9. Land taken for sharecropping (Excluding 1-6)', 
                                    '10. Land mortgaged (Including 1-6)', '11. Land taken on mortgage (Including 1-6)',
                                    '12. Land leased (Including 1-6)', '13. Land taken on lease (Excluding 1-6)'
...
<!--                                    <tr>
                                        ...
                                        <td>//<?php echo $this->Form->input('Section_GA_Upper_Marker.' . $i . '.SectionGA.amount_owned_land', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'style' => 'margin-top:3px')); ?></td>
                                        <td>//<?php echo $this->Form->input('Section_GA_Upper_Marker.' . $i . '.SectionGA.amount_land_cultivation', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'style' => 'margin-top:3px')); ?></td>
                                        <td>//<?php echo $this->Form->input('Section_GA_Upper_Marker.' . $i . '.SectionGA.main_crop', array('type' => 'select','options'=>$options,'class' => 'form-control', 'label' => false, 'style' => 'margin-top:3px')); ?></td>
                                        <td>//<?php echo $this->Form->input('Section_GA_Upper_Marker.' . $i . '.SectionGA.second_main_crop', array('type' => 'select','options'=>$options, 'class' => 'form-control', 'label' => false, 'style' => 'margin-top:3px')); ?></td>
                                        <td>//<?php echo $this->Form->input('Section_GA_Upper_Marker.' . $i . '.SectionGA.other_crops', array('type' => 'select','options'=>$options, 'class' => 'form-control', 'label' => false, 'style' => 'margin-top:3px')); ?></td>
                                    </tr>-->

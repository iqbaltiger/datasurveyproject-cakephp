                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                       ...
                       $occupation_list = array(
                                                  ...
                                                  '01'=>'Agriculture (own land)',
												  '02'=>'-(only mortgaged/borrowed or rented / bargha land)',
												  '03'=>'Agricultural labour (day labourer/agricultural labourer/assists in household agricultural activities)',
                                                  ...
                                                  '10'=>'Petty business',
												  '11'=>'Housewife',
                                                  '12'=>'Housekeeping in others household',
                                                  '13'=>'Garments’ worker',
                                                  '14'=>'Unemployed',
                                                  '15'=>'Student',
                                                  '16'=>'Not applicable (<6 years)',
...
<!--                                <tr>
								...
								<tr><td>211</td><td>What is your ethnic identity? (In your own language) </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
								
								 <tr><td>212</td><td>What is the name of your ethnic group in government records?</td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>
                                <tr><td>213</td><td>Is there any other given names of your ethnic group by which other ethnic groups of your neighborhood address you? </td><td><?php echo $this ->Form->input('name', array('type' => 'text', 'class' => 'form-control rdonly', 'label' => false, 'style' => 'margin-top:3px'));?></td></tr>                                                                                              
                              ...
                              'Post Graduate'
								 ...
								 <tr>
									...
									echo $this -> Form -> input('12.SectionQuestionAnswerCultural.answer', array('options' => $schooling, 'class' => 'form-control', 'empty' => '(choose one)', 'label' => false));
			 						?>  
			 ...
			 ?>   
                        ...
                        <div class="table-responsive">
				            ...
				            <?php echo $this->Form->input('SectionHouseholdArray.'.$i.'.SectiondHouseholdinfo.start_with_household_head',array('type'=>'text','class'=>'form-control','label'=>false,'style'=>'margin-top:3px')); ?>  
										...
										<?php //echo $this->Form->input('SectionHouseholdArray.'.$i.'.SectiondHouseholdinfo.education_level', array('options' => $educational_level,'class'=>'form-control','empty' => '(choose one)','label'=>false)); ?>    				
                                            <?php
											
											
							
				             echo $this->Form->input('SectionHouseholdArray.'.$i.'.SectiondHouseholdinfo.education_level', array('options' => $schooling,'class'=>'form-control','empty' => '(choose one)','label'=>false)); ?>    

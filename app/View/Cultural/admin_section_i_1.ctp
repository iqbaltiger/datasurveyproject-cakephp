...
<div class="row">
					...
					<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                       <?php echo $this->Form->create('SectionIFoodConsumption',array('class'=>'')) ?>
                         ...
                         <table class="table table-bordered table-striped">
                             <tr>
                                 <td>901</td>                             
    <td  colspan="10"><p><strong>Do you think all the members of the    family ate well three times a day in the last week? </strong></p></td>
  ...
  <tr>
    ...
    <td colspan="3"> <?php echo $this->form->input('no_of_meals',array('type'=>'select','options'=>array('01','02','03'),'class'=>'form-control','label'=>false)); ?></td>
    

     <td colspan="3"> <?php echo $this->form->input('no_of_meals',array('type'=>'select','options'=>array('01','02','03'),'class'=>'form-control','label'=>false)); ?></td>

      <td colspan="5"> <?php echo $this->form->input('no_of_meals',array('type'=>'select','options'=>array('01','02','03'),'class'=>'form-control','label'=>false)); ?></td>
     <td colspan="5"> <?php echo $this->form->input('no_of_meals',array('type'=>'select','options'=>array('01','02','03'),'class'=>'form-control','label'=>false)); ?></td>
  </tr>
  ...
  <tr>
      ...
      <td colspan="12"><p align="right"><?php echo $this->form->input('slack_season',array('type'=>'text','class'=>'form-control','label'=>false)); ?> </p></td>
    <td><p>Times </p></td>
  </tr>
  ...
  <?php
     ...
     $reason_of_proverty = array(
      ...
      'Lack of capital','Death of earning member of household','Loss through illegal land seizure','99'=>'Others (Please specify) _____________'
      ...
      $coping = array(
          ...
          'No special measures taken','Temporary migration in search of work','99'=>'Others (Please specify) _____________'
